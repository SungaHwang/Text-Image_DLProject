...
def summarize_and_save(input_file, output_file, tokenizer, model):
    ...
    inputs = tokenizer.encode("summarize: " + data, return_tensors="pt", max_length=16392, truncation=True)
...
for data_type in data_types:
    ...
    output_file_path = f"Text_Summarization/Results/2nd/sum2_test_data_{data_type}.txt"
